...
Telegram показывает их **только** пользователям с Telegram Premium. У
остальных автоматически рендерится **fallback** (то, что после `|`).
...
**только если у владельца бота есть активная подписка Telegram Premium**
